import { KeysOfUnion, DeepReadonly, SetConceptoState, XOR, ExtendsString, ConceptoCallback } from "./types";
...
declare type ACheck_Becomes = "different" | "true" | "false" | ((theValue: any, prevValue: any) => boolean);
...
declare type ItemEffect_RuleOptions<K_Type extends T_ItemType, K_PropertyName extends PropertyName<K_Type, T_ItemType, T_State>, T_ItemType extends string | number | symbol, T_State extends Record<any, any>, T_Refs extends Record<any, any>, T_FlowName extends string> = {
    check: ItemEffectRule_Check<K_Type, K_PropertyName, T_ItemType, T_State>;
    onItemEffect: ItemEffectCallback<K_Type, K_PropertyName, T_ItemType, T_State, T_Refs>;
...
declare type Effect_RuleOptions<K_Type extends T_ItemType, T_ItemType extends string | number | symbol, T_State extends Record<any, any>, T_FlowName extends string> = {
    name?: string;
...
declare type FlexibleRuleOptions<K_Type extends T_ItemType, K_PropertyName extends PropertyName<K_Type, T_ItemType, T_State>, T_ItemType extends string | number | symbol, T_State extends Record<any, any>, T_Refs extends Record<any, any>, T_FlowName extends string> = XOR<Effect_RuleOptions<K_Type, T_ItemType, T_State, T_FlowName>, ItemEffect_RuleOptions<K_Type, K_PropertyName, T_ItemType, T_State, T_Refs, T_FlowName>>;
declare type MakeRule_Rule<T_ItemType extends string | number | symbol, T_State extends Record<any, any>, T_Refs extends Record<any, any>, T_FlowName extends string> = FlexibleRuleOptions<T_ItemType, PropertyName<T_ItemType, T_ItemType, T_State>, T_ItemType, T_State, T_Refs, T_FlowName>;
...
export declare function _createConcepts<T_AllInfo extends {
    [T_ItemType: string]: {
        state: (itemName: any) => any;
        refs: (itemName: any, type: any) => any;
        startStates?: Record<any, any>;
    };
}, T_ItemType extends keyof T_AllInfo, T_FlowNamesParam extends Readonly<string[]>>(allInfo: T_AllInfo, extraOptions?: {
    ...
    setState: SetConceptoState<{ [K_Type in T_ItemType]: Record<T_AllInfo[K_Type]["startStates"] extends Record<string, any> ? keyof T_AllInfo[K_Type]["startStates"] : string, ReturnType<T_AllInfo[K_Type]["state"]>>; }>;
    onNextTick: (callback: ConceptoCallback) => void;
    ...
    makeRules: <K_RuleName extends string, K_RulesToAdd extends (addItemEffect: <K_Type_3 extends T_ItemType, K_PropertyName extends KeysOfUnion<{ [K_Type in T_ItemType]: Record<T_AllInfo[K_Type]["startStates"] extends Record<string, any> ? keyof T_AllInfo[K_Type]["startStates"] : string, ReturnType<T_AllInfo[K_Type]["state"]>>; }[K_Type_3][ExtendsString<KeysOfUnion<{ [K_Type in T_ItemType]: Record<T_AllInfo[K_Type]["startStates"] extends Record<string, any> ? keyof T_AllInfo[K_Type]["startStates"] : string, ReturnType<T_AllInfo[K_Type]["state"]>>; }[K_Type_3]>>]>>(options: ItemEffect_RuleOptions<K_Type_3, K_PropertyName, T_ItemType, { [K_Type in T_ItemType]: Record<T_AllInfo[K_Type]["startStates"] extends Record<string, any> ? keyof T_AllInfo[K_Type]["startStates"] : string, ReturnType<T_AllInfo[K_Type]["state"]>>; }, { [K_Type_1 in T_ItemType]: Record<T_AllInfo[K_Type_1]["startStates"] extends Record<string, any> ? keyof T_AllInfo[K_Type_1]["startStates"] : string, ReturnType<T_AllInfo[K_Type_1]["refs"]>>; }, "default" | T_FlowNamesParam[number]>) => any, addEffect: <K_Type_4 extends T_ItemType>(options: Effect_RuleOptions<K_Type_4, T_ItemType, { [K_Type in T_ItemType]: Record<T_AllInfo[K_Type]["startStates"] extends Record<string, any> ? keyof T_AllInfo[K_Type]["startStates"] : string, ReturnType<T_AllInfo[K_Type]["state"]>>; }, "default" | T_FlowNamesParam[number]>) => any) => Record<K_RuleName, MakeRule_Rule<T_ItemType, { [K_Type in T_ItemType]: Record<T_AllInfo[K_Type]["startStates"] extends Record<string, any> ? keyof T_AllInfo[K_Type]["startStates"] : string, ReturnType<T_AllInfo[K_Type]["state"]>>; }, { [K_Type_1 in T_ItemType]: Record<T_AllInfo[K_Type_1]["startStates"] extends Record<string, any> ? keyof T_AllInfo[K_Type_1]["startStates"] : string, ReturnType<T_AllInfo[K_Type_1]["refs"]>>; }, "default" | T_FlowNamesParam[number]>>>(rulesToAdd: K_RulesToAdd) => {
    ...
    makeDynamicRules: <K_RuleName_1 extends string, T_MakeRule_Function extends (...args: any) => MakeRule_Rule<T_ItemType, { [K_Type in T_ItemType]: Record<T_AllInfo[K_Type]["startStates"] extends Record<string, any> ? keyof T_AllInfo[K_Type]["startStates"] : string, ReturnType<T_AllInfo[K_Type]["state"]>>; }, { [K_Type_1 in T_ItemType]: Record<T_AllInfo[K_Type_1]["startStates"] extends Record<string, any> ? keyof T_AllInfo[K_Type_1]["startStates"] : string, ReturnType<T_AllInfo[K_Type_1]["refs"]>>; }, "default" | T_FlowNamesParam[number]>, T_RulesToAdd = Record<K_RuleName_1, T_MakeRule_Function>>(rulesToAdd: (addItemEffect: <K_Type_5 extends T_ItemType, K_PropertyName_1 extends KeysOfUnion<{ [K_Type in T_ItemType]: Record<T_AllInfo[K_Type]["startStates"] extends Record<string, any> ? keyof T_AllInfo[K_Type]["startStates"] : string, ReturnType<T_AllInfo[K_Type]["state"]>>; }[K_Type_5][ExtendsString<KeysOfUnion<{ [K_Type in T_ItemType]: Record<T_AllInfo[K_Type]["startStates"] extends Record<string, any> ? keyof T_AllInfo[K_Type]["startStates"] : string, ReturnType<T_AllInfo[K_Type]["state"]>>; }[K_Type_5]>>]>, T_Options extends unknown>(theRule: (options: T_Options) => ItemEffect_RuleOptions<K_Type_5, K_PropertyName_1, T_ItemType, { [K_Type in T_ItemType]: Record<T_AllInfo[K_Type]["startStates"] extends Record<string, any> ? keyof T_AllInfo[K_Type]["startStates"] : string, ReturnType<T_AllInfo[K_Type]["state"]>>; }, { [K_Type_1 in T_ItemType]: Record<T_AllInfo[K_Type_1]["startStates"] extends Record<string, any> ? keyof T_AllInfo[K_Type_1]["startStates"] : string, ReturnType<T_AllInfo[K_Type_1]["refs"]>>; }, "default" | T_FlowNamesParam[number]>) => (options: T_Options) => any, addEffect: <K_Type_6 extends T_ItemType, T_Options_1 extends unknown>(theRule: (options: T_Options_1) => Effect_RuleOptions<K_Type_6, T_ItemType, { [K_Type in T_ItemType]: Record<T_AllInfo[K_Type]["startStates"] extends Record<string, any> ? keyof T_AllInfo[K_Type]["startStates"] : string, ReturnType<T_AllInfo[K_Type]["state"]>>; }, "default" | T_FlowNamesParam[number]>) => (options: T_Options_1) => any) => T_RulesToAdd) => {
    ...
    startEffect: <K_Type_7 extends T_ItemType>(theEffect: Effect_RuleOptions<K_Type_7, T_ItemType, { [K_Type in T_ItemType]: Record<T_AllInfo[K_Type]["startStates"] extends Record<string, any> ? keyof T_AllInfo[K_Type]["startStates"] : string, ReturnType<T_AllInfo[K_Type]["state"]>>; }, "default" | T_FlowNamesParam[number]>) => void;
    startItemEffect: <K_Type_8 extends T_ItemType, K_PropertyName_2 extends KeysOfUnion<{ [K_Type in T_ItemType]: Record<T_AllInfo[K_Type]["startStates"] extends Record<string, any> ? keyof T_AllInfo[K_Type]["startStates"] : string, ReturnType<T_AllInfo[K_Type]["state"]>>; }[K_Type_8][ExtendsString<KeysOfUnion<{ [K_Type in T_ItemType]: Record<T_AllInfo[K_Type]["startStates"] extends Record<string, any> ? keyof T_AllInfo[K_Type]["startStates"] : string, ReturnType<T_AllInfo[K_Type]["state"]>>; }[K_Type_8]>>]>>({ check, onItemEffect, whenToRun, name, flow, }: ItemEffect_RuleOptions<K_Type_8, K_PropertyName_2, T_ItemType, { [K_Type in T_ItemType]: Record<T_AllInfo[K_Type]["startStates"] extends Record<string, any> ? keyof T_AllInfo[K_Type]["startStates"] : string, ReturnType<T_AllInfo[K_Type]["state"]>>; }, { [K_Type_1 in T_ItemType]: Record<T_AllInfo[K_Type_1]["startStates"] extends Record<string, any> ? keyof T_AllInfo[K_Type_1]["startStates"] : string, ReturnType<T_AllInfo[K_Type_1]["refs"]>>; }, "default" | T_FlowNamesParam[number]>) => string;
    stopEffect: (listenerName: string) => void;
    useStore: <K_Type_9 extends T_ItemType, T_ReturnedConceptoProps>(whatToReturn: (state: DeepReadonly<{ [K_Type in T_ItemType]: Record<T_AllInfo[K_Type]["startStates"] extends Record<string, any> ? keyof T_AllInfo[K_Type]["startStates"] : string, ReturnType<T_AllInfo[K_Type]["state"]>>; }>) => T_ReturnedConceptoProps, check: EffectRule_Check<K_Type_9, T_ItemType, { [K_Type in T_ItemType]: Record<T_AllInfo[K_Type]["startStates"] extends Record<string, any> ? keyof T_AllInfo[K_Type]["startStates"] : string, ReturnType<T_AllInfo[K_Type]["state"]>>; }>, hookDeps?: any[]) => T_ReturnedConceptoProps;
    useStoreEffect: <K_Type_10 extends T_ItemType>(onEffect: EffectCallback<T_ItemType, { [K_Type in T_ItemType]: Record<T_AllInfo[K_Type]["startStates"] extends Record<string, any> ? keyof T_AllInfo[K_Type]["startStates"] : string, ReturnType<T_AllInfo[K_Type]["state"]>>; }>, check: EffectRule_Check<K_Type_10, T_ItemType, { [K_Type in T_ItemType]: Record<T_AllInfo[K_Type]["startStates"] extends Record<string, any> ? keyof T_AllInfo[K_Type]["startStates"] : string, ReturnType<T_AllInfo[K_Type]["state"]>>; }>, hookDeps?: any[]) => void;
    ...
    useStoreItemPropsEffect: <K_Type_13 extends T_ItemType>(checkItem: {
        ...
        flow?: "default" | T_FlowNamesParam[number];
