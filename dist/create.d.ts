...
declare type ItemEffect_RuleOptions__NoEffect<K_Type extends T_ItemType, K_PropertyName extends PropertyName<K_Type, T_ItemType, T_State>, T_ItemType extends string | number | symbol, T_State extends Record<any, any>, T_Refs extends Record<any, any>, T_StepName extends string> = {
    check: ItemEffectRule_Check<K_Type, K_PropertyName, T_ItemType, T_State>;
    atStepEnd?: boolean;
    name?: string;
    step?: T_StepName;
...
declare type Effect_RuleOptions__NoEffect<K_Type extends T_ItemType, T_ItemType extends string | number | symbol, T_State extends Record<any, any>, T_StepName extends string> = {
    name?: string;
    check: EffectRule_Check<K_Type, T_ItemType, T_State>;
    atStepEnd?: boolean;
    step?: T_StepName;
...
export declare function _createStoreHelpers<T_AllInfo extends {
    ...
    makeRules: <K_RuleName extends string, K_RulesToAdd extends (arg0: {
        itemEffect: <K_Type_3 extends T_ItemType, K_PropertyName extends KeysOfUnion<{ [K_Type in T_ItemType]: Record<T_AllInfo[K_Type]["startStates"] extends Record<string, any> ? keyof T_AllInfo[K_Type]["startStates"] : string, ReturnType<T_AllInfo[K_Type]["state"]>>; }[K_Type_3][ExtendsString<KeysOfUnion<{ [K_Type in T_ItemType]: Record<T_AllInfo[K_Type]["startStates"] extends Record<string, any> ? keyof T_AllInfo[K_Type]["startStates"] : string, ReturnType<T_AllInfo[K_Type]["state"]>>; }[K_Type_3]>>]>>(onItemEffect: ItemEffectCallback<K_Type_3, K_PropertyName, T_ItemType, { [K_Type in T_ItemType]: Record<T_AllInfo[K_Type]["startStates"] extends Record<string, any> ? keyof T_AllInfo[K_Type]["startStates"] : string, ReturnType<T_AllInfo[K_Type]["state"]>>; }, { [K_Type_1 in T_ItemType]: Record<T_AllInfo[K_Type_1]["startStates"] extends Record<string, any> ? keyof T_AllInfo[K_Type_1]["startStates"] : string, ReturnType<T_AllInfo[K_Type_1]["refs"]>>; }>, options: ItemEffect_RuleOptions__NoEffect<K_Type_3, K_PropertyName, T_ItemType, { [K_Type in T_ItemType]: Record<T_AllInfo[K_Type]["startStates"] extends Record<string, any> ? keyof T_AllInfo[K_Type]["startStates"] : string, ReturnType<T_AllInfo[K_Type]["state"]>>; }, { [K_Type_1 in T_ItemType]: Record<T_AllInfo[K_Type_1]["startStates"] extends Record<string, any> ? keyof T_AllInfo[K_Type_1]["startStates"] : string, ReturnType<T_AllInfo[K_Type_1]["refs"]>>; }, "default" | T_StepNamesParam[number]>) => any;
        effect: <K_Type_4 extends T_ItemType>(onEffect: EffectCallback<T_ItemType, { [K_Type in T_ItemType]: Record<T_AllInfo[K_Type]["startStates"] extends Record<string, any> ? keyof T_AllInfo[K_Type]["startStates"] : string, ReturnType<T_AllInfo[K_Type]["state"]>>; }>, options: Effect_RuleOptions__NoEffect<K_Type_4, T_ItemType, { [K_Type in T_ItemType]: Record<T_AllInfo[K_Type]["startStates"] extends Record<string, any> ? keyof T_AllInfo[K_Type]["startStates"] : string, ReturnType<T_AllInfo[K_Type]["state"]>>; }, "default" | T_StepNamesParam[number]>) => any;
    ...
    makeDynamicRules: <K_RuleName_1 extends string, T_MakeRule_Function extends (...args: any) => MakeRule_Rule<T_ItemType, { [K_Type in T_ItemType]: Record<T_AllInfo[K_Type]["startStates"] extends Record<string, any> ? keyof T_AllInfo[K_Type]["startStates"] : string, ReturnType<T_AllInfo[K_Type]["state"]>>; }, { [K_Type_1 in T_ItemType]: Record<T_AllInfo[K_Type_1]["startStates"] extends Record<string, any> ? keyof T_AllInfo[K_Type_1]["startStates"] : string, ReturnType<T_AllInfo[K_Type_1]["refs"]>>; }, "default" | T_StepNamesParam[number]>, T_RulesToAdd = Record<K_RuleName_1, T_MakeRule_Function>>(rulesToAdd: (itemEffect: <K_Type_5 extends T_ItemType, K_PropertyName_1 extends KeysOfUnion<{ [K_Type in T_ItemType]: Record<T_AllInfo[K_Type]["startStates"] extends Record<string, any> ? keyof T_AllInfo[K_Type]["startStates"] : string, ReturnType<T_AllInfo[K_Type]["state"]>>; }[K_Type_5][ExtendsString<KeysOfUnion<{ [K_Type in T_ItemType]: Record<T_AllInfo[K_Type]["startStates"] extends Record<string, any> ? keyof T_AllInfo[K_Type]["startStates"] : string, ReturnType<T_AllInfo[K_Type]["state"]>>; }[K_Type_5]>>]>, T_Options extends unknown>(theRule: (options: T_Options) => ItemEffect_RuleOptions<K_Type_5, K_PropertyName_1, T_ItemType, { [K_Type in T_ItemType]: Record<T_AllInfo[K_Type]["startStates"] extends Record<string, any> ? keyof T_AllInfo[K_Type]["startStates"] : string, ReturnType<T_AllInfo[K_Type]["state"]>>; }, { [K_Type_1 in T_ItemType]: Record<T_AllInfo[K_Type_1]["startStates"] extends Record<string, any> ? keyof T_AllInfo[K_Type_1]["startStates"] : string, ReturnType<T_AllInfo[K_Type_1]["refs"]>>; }, "default" | T_StepNamesParam[number]>) => (options: T_Options) => any, effect: <K_Type_6 extends T_ItemType, T_Options_1 extends unknown>(theRule: (options: T_Options_1) => Effect_RuleOptions<K_Type_6, T_ItemType, { [K_Type in T_ItemType]: Record<T_AllInfo[K_Type]["startStates"] extends Record<string, any> ? keyof T_AllInfo[K_Type]["startStates"] : string, ReturnType<T_AllInfo[K_Type]["state"]>>; }, "default" | T_StepNamesParam[number]>) => (options: T_Options_1) => any) => T_RulesToAdd) => {
